...
public class BinomialTest {
	 ...
	 * ved et gitt antall forsøk. Antar at sannsynligheten er 0.5 for at hver suksess vil inntreffe.
	 * 
	 * @param antForsok
	 * @param suksesser
	 * @return p-value, sannsynligheten for at et minst så ekstremt tilfellet vil inntreffe.
	 */
	...
	public static BigDecimal binomialkoeffisient(final int N, final int K) {
		...
		for (int k = 0; k < K; k++) {
			resultat = resultat.multiply(BigDecimal.valueOf(N-k)).divide(BigDecimal.valueOf(k+1));
		}
		return resultat;
	}
}